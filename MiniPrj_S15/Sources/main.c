...
char mode = 0;   // variable that shall hold the modes: alarm set, game mode or time set
...
unsigned char hrs = 0x22;

unsigned char counter = 0;
char nightcnt = 0;    // night time counter
char nightflag = 0;
...
char j;
char correct;
unsigned char seq = 0;  // sequence of correct input from user
...
/* Initialize digital I/O port pins */
  ...
  DDRAD = 0x03;      // pins 0 and 1 are SS pins for LEDs and DEC points
...
/* Initialize Slave Select Pins - PORT M */
   ...
   DDRT = 0x3F;    // use PT0 to select secs
